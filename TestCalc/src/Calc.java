...
class Calc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Введите пару чисел (арабских или римских):"); // Ввод.
        String expression = scanner.nextLine(); //Считывание введенного выражения.
        System.out.println(parse(expression)); //Вывод вычисленного выражения.
    }
    ...
    public static String parse(String expression) throws Exception { //Метод parse.
        ...
        String result;
        boolean isRoman;
        String[] operands = expression.split("[+\\-*/]");//Дробление выражения на operands[] по знаку действия.
        if (operands.length != 2) throw new Exception("Должно быть два числа ");//  Проверяем, что в выражении 2 операнда.
        ...
        if (isRoman) {
            //если римское число получилось меньше либ равно нулю, генерируем ошибку.
            if (arabian <= 0) {
...
class Roman {
    static String[] romanArray = new String[] {"0", "I", "II", "III", "IV", "V",
            ...
            "LVI", "LVII", "LVIII", "XIX", "LX", "LXI", "LXII", "LX'III", "LXIV", "LXV", "LXVI",
